...
1. Download both files (`gamma_control.bat` and `SetGamma.ps1`)
2. Place them in the same folder
3. Right-click `gamma_control.bat` → Run as Administrator
4. If Windows Defender prompts you, click "More info" → "Run anyway"  
